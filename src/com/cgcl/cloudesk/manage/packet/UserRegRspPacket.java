...
public class UserRegRspPacket extends PacketBase {
	private boolean				bSuccess = false;

	public UserRegRspPacket()
	{
		super(PacketConfig.kUserRegRspPacketType, PacketConfig.kAuthorizeModuleId);
	}
	
	public UserRegRspPacket(boolean bSuccess)
	{
		super(PacketConfig.kUserRegRspPacketType, PacketConfig.kAuthorizeModuleId);
