...
public class UserLogoutPacket extends PacketBase {
	private String				username = null;
	
	public UserLogoutPacket()
	{
		super(PacketConfig.kUserLogoutPacketType, PacketConfig.kAuthorizeModuleId);
	}
	
	public UserLogoutPacket(String username)
	{
		super(PacketConfig.kUserLogoutPacketType, PacketConfig.kAuthorizeModuleId);
