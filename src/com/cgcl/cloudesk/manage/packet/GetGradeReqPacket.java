...
public class GetGradeReqPacket extends PacketBase {
private String				userID = null;
	
	public GetGradeReqPacket()
	{
		super(PacketConfig.kGetGradePacketReqType, PacketConfig.kAuthorizeModuleId);
	}
	
	public GetGradeReqPacket(String userID)
	{
		super(PacketConfig.kGetGradePacketReqType, PacketConfig.kAuthorizeModuleId);
		this.userID = userID;
	}
